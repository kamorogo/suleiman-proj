# Generated by Django 5.1.6 on 2025-04-04 11:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.FileField(blank=True, upload_to='subscription/')),
                ...
                ('users', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscription', to='LicenseTrack.users')),
            ],
        ),
        migrations.CreateModel(
            name='Renewals',
